...
public class UsuarioCadastroController {
    ...
    @PutMapping("/usuario")
    public ResponseEntity<UsuarioRespostaDTO> alterar(@RequestBody UsuarioDTO usuarioDTO){
        Usuario usuario = usuarioCadastroService.salvar(usuarioDTO.transformaParaObjeto());
        return  new ResponseEntity<>(UsuarioRespostaDTO.transformaEmDTO(usuario), HttpStatus.OK);
    }
